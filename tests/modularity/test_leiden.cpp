...
namespace {
constexpr auto algorithm = ModularityAlgorithm::Leiden;
} // namespace

TEST_F(ModularityLeidenTest, testStandard) {
...
TEST_F(ModularityLeidenTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(ModularityLeidenTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(ModularityLeidenTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(ModularityLeidenTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(ModularityLeidenTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(ModularityLeidenTest, testStandardFourRanks) {
...
TEST_F(ModularityLeidenTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(ModularityLeidenTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
