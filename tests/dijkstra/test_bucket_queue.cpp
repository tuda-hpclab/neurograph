...
namespace {
constexpr auto queue_type = DijkstraQueueType::BucketQueue;
} // namespace

TEST_F(DijkstraBucketQueueTest, testStandard) {
...
TEST_F(DijkstraBucketQueueTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testStandardFourRanks) {
...
TEST_F(DijkstraBucketQueueTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testInverseIsRejected) {
    if (skip_unless_rank_count(1)) {
        return;
    }
    ...
    // The bucket queue requires integer distances, so the inverse metric must be rejected
    ASSERT_THROW((void)AllPairsShortestPath::compute_apsp_inverse(graph, queue_type), utility::Exception);
}

TEST_F(DijkstraBucketQueueTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testStandardSevenRanks) {
...
TEST_F(DijkstraBucketQueueTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(DijkstraBucketQueueTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
