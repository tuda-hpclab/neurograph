...
namespace {
constexpr auto queue_type = DijkstraQueueType::PriorityQueue;
} // namespace

TEST_F(DijkstraPriorityQueueTest, testStandard) {
...
TEST_F(DijkstraPriorityQueueTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardFourRanks) {
...
TEST_F(DijkstraPriorityQueueTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardInverse) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardFourRanksInverse) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testStandardSevenRanks) {
...
TEST_F(DijkstraPriorityQueueTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(DijkstraPriorityQueueTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
