...
#include "test_path_enumeration.h"
...
namespace {
constexpr auto algorithm = BetweennessCentralityAlgorithm::PathEnumeration;
} // namespace

TEST_F(BetweennessPathEnumerationTest, testStandard) {
...
TEST_F(BetweennessPathEnumerationTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testStandardFourRanks) {
...
TEST_F(BetweennessPathEnumerationTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testStandardSevenRanks) {
...
TEST_F(BetweennessPathEnumerationTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(BetweennessPathEnumerationTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
