...
#include "test_distributed_push_relabel.h"
...
namespace {
constexpr auto algorithm = MaxFlowAlgorithm::DistributedPushRelabel;
} // namespace

TEST_F(MaxFlowDistributedPushRelabelTest, testStandard) {
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardBottleneck) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardReverse) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardMultipleSourcesAndSinks) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testNegativeWeights) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardFourRanks) {
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardMultipleSourcesAndSinksFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardSeparateComponentsSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardSevenRanks) {
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowDistributedPushRelabelTest, testStandardSeparateComponentsSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
