...
namespace {
constexpr auto algorithm = MaxFlowAlgorithm::Dinic;
} // namespace

TEST_F(MaxFlowDinicTest, testStandard) {
...
TEST_F(MaxFlowDinicTest, testStandardBottleneck) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardReverse) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardMultipleSourcesAndSinks) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testNegativeWeights) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardFourRanks) {
...
TEST_F(MaxFlowDinicTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardMultipleSourcesAndSinksFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardSeparateComponentsSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardSevenRanks) {
...
TEST_F(MaxFlowDinicTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowDinicTest, testStandardSeparateComponentsSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
