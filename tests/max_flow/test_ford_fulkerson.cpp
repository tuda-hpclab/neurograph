...
namespace {
constexpr auto algorithm = MaxFlowAlgorithm::FordFulkerson;
} // namespace

TEST_F(MaxFlowFordFulkersonTest, testStandard) {
...
TEST_F(MaxFlowFordFulkersonTest, testStandardBottleneck) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardReverse) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardMultipleSourcesAndSinks) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testNegativeWeights) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardFourRanks) {
...
TEST_F(MaxFlowFordFulkersonTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardMultipleSourcesAndSinksFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardSeparateComponentsSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardSevenRanks) {
...
TEST_F(MaxFlowFordFulkersonTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowFordFulkersonTest, testStandardSeparateComponentsSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
