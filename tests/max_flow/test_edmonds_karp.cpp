...
namespace {
constexpr auto algorithm = MaxFlowAlgorithm::EdmondsKarp;
} // namespace

TEST_F(MaxFlowEdmondsKarpTest, testStandard) {
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardBottleneck) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardReverse) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardMultipleSourcesAndSinks) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testNegativeWeights) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardFourRanks) {
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardMultipleSourcesAndSinksFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardSeparateComponentsSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardSevenRanks) {
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(MaxFlowEdmondsKarpTest, testStandardSeparateComponentsSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
