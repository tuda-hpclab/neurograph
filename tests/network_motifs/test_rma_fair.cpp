...
namespace {
constexpr auto algorithm = NetworkMotifAlgorithm::RmaFair;
} // namespace

namespace census = network_motif_expectations;

TEST_F(NetworkMotifsRmaFairTest, testStandard) {
...
TEST_F(NetworkMotifsRmaFairTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testStandardFourRanks) {
...
TEST_F(NetworkMotifsRmaFairTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testStandardSevenRanks) {
...
TEST_F(NetworkMotifsRmaFairTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFairTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
