...
namespace {
constexpr auto algorithm = NetworkMotifAlgorithm::Rma;
} // namespace

namespace census = network_motif_expectations;

TEST_F(NetworkMotifsRmaTest, testStandard) {
...
TEST_F(NetworkMotifsRmaTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testStandardFourRanks) {
...
TEST_F(NetworkMotifsRmaTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testStandardSevenRanks) {
...
TEST_F(NetworkMotifsRmaTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
