...
#include "test_rma_fewer_messages.h"
...
namespace {
constexpr auto algorithm = NetworkMotifAlgorithm::RmaFewerMessages;
} // namespace

namespace census = network_motif_expectations;

TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandard) {
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardFourRanks) {
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardSevenRanks) {
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerMessagesTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
