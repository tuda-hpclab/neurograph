...
namespace {
constexpr auto algorithm = NetworkMotifAlgorithm::RmaFewerArcs;
} // namespace

namespace census = network_motif_expectations;

TEST_F(NetworkMotifsRmaFewerArcsTest, testStandard) {
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardUU) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testFull) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardUUFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testFullFourRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardFourRanks) {
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardUUFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testFullFourRanks) {
    if (skip_unless_rank_count(4)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardUUSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testFullSevenRanksDummy) {
    if (skip_unless_rank_count(1)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardSevenRanks) {
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testStandardUUSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
...
TEST_F(NetworkMotifsRmaFewerArcsTest, testFullSevenRanks) {
    if (skip_unless_rank_count(7)) {
        return;
    }
