...
/**
 * @brief Implements the delta-stepping epoch strategy that checks via RMA whether a newly
 *		calculated distance is lower than the target's current one, and only pushes those values.
 */
class PushCheckVariant {
public:
    /**
