...
// <fmt/ranges.h>, not <fmt/format.h>, for the primary template of the fmt::is_tuple_like
// specialization below. Including it here puts that specialization in place whether or not a
// consumer includes <fmt/ranges.h> itself.
...
// Without {fmt} the library has no formatter; std::ostream& operator<< above stays either way.
#if !defined(CPP_UTILITIES_NO_FMT)
/**
