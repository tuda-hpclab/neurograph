...
public:
    ...
    void report([[maybe_unused]] const std::uint64_t current_iteration) {
        ...
        *output_stream_ << algo_name_ << ": Processed a total of " << processed_estimate << " of " << num_global_iterations_ << " iterations.\n";
    }
    ...
    void finish() const {
        ...
        *output_stream_ << "Processed all iterations of " << algo_name_ << '\n';
    }
